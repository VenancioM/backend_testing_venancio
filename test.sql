...
SELECT name, title, rating, rating_date  FROM ratings INNER JOIN books ON ratings.book_id = books.id INNER JOIN reviewers ON ratings.reviewer_id = reviewers.id order by name, title, rating

-- Dump completed on 2022-07-08 11:27:41
